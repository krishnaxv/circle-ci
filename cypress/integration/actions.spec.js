...
context("Actions", () => {
  ...
  it(".click() - click on a DOM element", () => {
    ...
    // .click() accepts an x and y coordinate that controls where the click occurs :)
  ...
  it(".dblclick() - double click on a DOM element", () => {
    ...
    // Our app has a listener on 'dblclick' event in our 'scripts.js' that hides the div and shows an input on double click
    cy.get(".action-div")
      .dblclick()
  ...
  it(".scrollIntoView() - scroll an element into view", () => {
    ...
    // Normally all of these buttons are hidden, because they're not within the viewable area of their parent (we need to scroll to see them)
